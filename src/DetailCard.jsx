                    ...
                    <div className="row" id="row-2">
                        ...
                        <div className="col-xl-4">
                            <div className="container" id="container-img">
                                <img className="card-img-top" id="detail-images" src={this.props.image}
                                     alt="detail-item"/>
                            </div>
                        </div>
                                    ...
                                    <li className="list-group-item">
                                        <form>
                                            <div className="form-group row">
                                                ...
                                                <input type="number" className="form-control" min="1" id="select-qty"
                                                       placeholder=""/>

                                            </div>
                                            <div className="form-group">
                                                <button type="submit" className="btn btn-dark btn-sm btn-lg btn-block">
